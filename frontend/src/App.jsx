...
import AdminHoje from "./pages/AdminHoje"; // 👈 novo import
      ...
      <div className="max-w-6xl mx-auto p-4">
        <header className="flex items-center justify-between py-3">
          ...
          <nav className="space-x-4">
            ...
            {/* 👇 link opcional para admin */}
            <Link to="/admin/hoje">Admin</Link>
          </nav>
        </header>
        ...
        <Routes>
          ...
          <Route
            path="/especialistas/:id/calendario"
            element={<Calendario />}
          />
          <Route path="/minhas-consultas" element={<MinhasConsultas />} />
          <Route path="/entrar" element={<Login />} />
          <Route path="/admin/hoje" element={<AdminHoje />} /> {/* 👈 rota admin */}
        </Routes>
      </div>
    </BrowserRouter>
  );
